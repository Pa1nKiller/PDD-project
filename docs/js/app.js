(() => {
            ...
            switch (target.className) {
              case PLAY:
                ...
                textContent.split(/[.,]+/).forEach((text => {
                    ...
                    console.log(trimmed);
                    if (trimmed) {
                        const U = getUtterance(target, trimmed);
                        console.log(U);
    ...
    nextbtn.addEventListener("click", (() => {
        ...
        if (indexCar < 2) {
            ...
            if (indexJusttest < 4) {
                console.log(dublicateIndexJusttext);
                let r = getRandomInt(1, 6);
                while (dublicateIndexJusttext.includes(r)) {
                    console.log(dublicateIndexJusttext.includes(r));
                    console.log(r);
                    r = getRandomInt(1, 6);
                }
                inxJusttest = r;
                dublicateIndexJusttext.push(inxJusttest);
                indexJusttest++;
